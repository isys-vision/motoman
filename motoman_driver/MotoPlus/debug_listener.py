...
def main():
    ...
    parser.add_argument('-f', '--file-sync', action='store_true',
        help='Do log to files, not only to console')
    ...
    print('Listening for MotoROS debug msgs (format: "[time_msg_rcvd] [ip:port] msg") ..')
    print('---')
